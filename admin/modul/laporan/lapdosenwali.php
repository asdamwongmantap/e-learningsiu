<?php
    ...
    $query ="select k.nid, d.namadsn, d.alamat, d.kota, d.email, k.kd_kelas from tbl_kelas k, tbl_dosen d where k.nid=d.nid";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(34,1,'LAPORAN DATA DOSEN WALI',"",1,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
   ...
   // $pdf->Cell(1,1,'NO','LRTB',0,'C');
    ...
    $pdf->Cell(7,1,'Nama Dosen','LRTB',0,'C');
    $pdf->Cell(9,1,'Alamat','LRTB',0,'C');
    $pdf->Cell(3,1,'Kota','LRTB',0,'C');
	$pdf->Cell(6,1,'Email','LRTB',0,'C');
	$pdf->Cell(6,1,'Wali Dosen Kelas','LRTB',0,'C');
    $pdf->Ln();
