<?php
    ...
    $query ="select nim, namamhs, alamat, kota, email, tgllahir from tbl_mahasiswa";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(34,1,'LAPORAN DATA MAHASISWA KESELURUHAN',"",1,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
