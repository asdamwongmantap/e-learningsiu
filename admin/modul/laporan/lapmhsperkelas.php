<?php
	...
	$LAPKLS=$_POST['lapkelas'];
    $query ="select nim, namamhs, alamat, email, kota,kd_kelas from tbl_mahasiswa where kd_kelas like '$LAPKLS%'";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(34,1,'LAPORAN DATA MAHASISWA PER-KELAS',"",1,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
