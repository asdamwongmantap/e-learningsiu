<?php
    ...
    $query ="select n.nim, mhs.namamhs, mhs.kd_kelas, mk.nma_mk, s.tgl_ujian, n.nilaiakhir  from tbl_mahasiswa mhs, tbl_nilai n, tbl_soal s, tbl_matakuliah mk where n.nim=mhs.nim AND n.kd_mk=mk.kd_mk AND n.id_soalujian=s.id_soalujian";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(34,1,'LAPORAN DATA NILAI MAHASISWA KESELURUHAN',"",1,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
