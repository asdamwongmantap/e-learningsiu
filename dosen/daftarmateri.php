...
from tbl_pengguna p, tbl_dosen d where p.username=d.nid AND p.username='$nid'");
  ...
  box-shadow: 1px 1px 2px rgba(0,0,0,.3);"><center>
	...
	<p align='right' style="margin-right:10px;"><a href='?hal=addmateri' role='button' class='btn'>Tambah Materi</a></p>
	...
	?>
        ...
        <tr>
                                    ...
                                    <td><a href='?hal=editmateri&id=<?php echo $r['kd_materi']?>'>EDIT</a>&nbsp;|
									    <a href='?hal=hapusmateri&id=<?php echo $r['kd_materi']?>&namafile=<?php echo $r['filename']?>'>HAPUS</td>
        </tr>
    <?php
	}
	?>
