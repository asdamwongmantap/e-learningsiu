...
from tbl_pengguna p, tbl_dosen d where p.username=d.nid AND p.username='$nid'");
  ...
  box-shadow: 1px 1px 2px rgba(0,0,0,.3);"><center>
			<div class="page">
    <h3 style="margin-top:10px;">Daftar NILAI UJIAN MHS</h3>
...
<table class="layout display responsive-table">
    ...
    <tbody>
	<?php
		$tp=mysql_query('SELECT n.kd_mk, mk.nma_mk, s.tgl_ujian, n.kd_kelas, n.nim, mhs.namamhs, n.nilaiakhir FROM tbl_nilai n , tbl_matakuliah mk, tbl_soal s , tbl_mahasiswa mhs WHERE n.kd_mk=mk.kd_mk AND n.id_soalujian=s.id_soalujian AND n.nim=mhs.nim AND s.nid='.$_SESSION['username'].' ORDER BY n.kd_kelas  ASC');
