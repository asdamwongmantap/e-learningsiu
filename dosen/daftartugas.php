...
<table class="layout display responsive-table">
    ...
    <tbody>
	<?php
		$tp=mysql_query('SELECT tbl_tugas.kd_tugas,tbl_tugas.kd_mk, tbl_dosenmk.kd_mk, tbl_matakuliah.nma_mk, tbl_tugas.kd_kelas, tbl_tugas.judultugas, tbl_tugas.deskripsi, tbl_tugas.filename FROM tbl_tugas, tbl_matakuliah, tbl_dosenmk where  tbl_tugas.kd_mk=tbl_matakuliah.kd_mk AND tbl_dosenmk.kd_mk=tbl_tugas.kd_mk 
		AND tbl_dosenmk.nid='.$_SESSION['username'].' ');
	...
	?>
        ...
        <tr>
                                    ...
                                    <td><a href="downloadtugas.php?id=<?php echo $r['kd_tugas']?>">Download</a></td>
        </tr>
    <?php
	}
	?>
