               ...
               <h6>Edit Materi</h6>
                <div class="row">
                  <div class="span7 content-wrapper clearfix">
                    <div class="right-col">
                      <form action="ubah_materi.php" enctype="multipart/form-data" method="post">
                       <ul class="rr">
                        <table  style="border: 0pt dashed #0000CC;float:left;width:100%;" border="0" >
                          <tr><td><input class="text-input"  style="width:50%;" type="hidden" name="id" placeholder="Kode Materi" value="<?php echo $r['kd_materi']?>"/></td></tr>
						...
						?>
						  ...
						  <tr><td><textarea class="text-input" name="judul_materi" placeholder="Tulliskan Judul Materi..."><?php echo $r['judul_materi'] ?></textarea></td></tr>
                          <tr><td><textarea class="text-input" name="deskripsi" placeholder="Tulliskan Deskripsi Materi..."><?php echo $r['deskripsi'] ?></textarea></td></tr>
