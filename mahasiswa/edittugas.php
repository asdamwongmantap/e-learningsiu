               ...
               <h6>Edit Tugas</h6>
                <div class="row">
                  <div class="span7 content-wrapper clearfix">
                    <div class="right-col">
                      <form action="ubah_tugas.php" enctype="multipart/form-data" method="post">
                       <ul class="rr">
                        <table  style="border: 0pt dashed #0000CC;float:left;width:100%;" border="0" >
                          <tr><td><input class="text-input"  style="width:50%;" type="hidden" name="id" placeholder="Kode Tugas" value=<?php echo $r['kd_tugas']?>/></td></tr>
						...
						?>
						  ...
						  <tr><td><textarea class="text-input" name="judultugas" placeholder="Tulliskan Judul Tugas..."><?php echo $r['judultugas'] ?></textarea></td></tr>
                          <tr><td><textarea class="text-input" name="deskripsi" placeholder="Tulliskan Deskripsi Tugas..."><?php echo $r['deskripsi'] ?></textarea></td></tr>
