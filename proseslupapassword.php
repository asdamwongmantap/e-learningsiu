...
$cek_email=mysql_num_rows(mysql_query("SELECT username FROM tbl_pengguna WHERE username='$_POST[username]'"));
...
mysql_query("UPDATE tbl_pengguna SET password='$password' where username='$username'");
